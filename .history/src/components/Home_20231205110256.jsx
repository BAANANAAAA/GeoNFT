...
function Home() {
  ...
  const handleError = () => {
    // Handle the error gracefully, for example, show a user-friendly message
    console.error('Web3 connection error:', error)

    // Check if it's a MetaMask rejection error
    if (error instanceof Error && error.code === 'ACTION_REJECTED') {
      // Handle the rejection gracefully, e.g., show a message to the user
